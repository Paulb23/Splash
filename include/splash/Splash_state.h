...
\-----------------------------------------------------------------------------*/
extern DLL_EXPORT Splash_state SPLASHCALL *splash_state_create(void (* init)(char *, void *), void (* update)(char *, double), void (* event)(char *, SDL_Event), void (* render)(char *), void (* cleanup)(char *) );
